...
import 'package:bilbao_accesible/view/origenDestino.dart';
...
class _MapViewState extends State<Origen> {
      ...
      child: Scaffold(
        ...
        body: Stack(
          children: <Widget>[
            // Map View
            GoogleMap(
              markers: Set<Marker>.from(markers), //indicamos de donde imprime markers
        ...
        bottomNavigationBar: NavigationBar(
          onDestinationSelected: (int index) {
            if(index == 1){
              Navigator.push(
                  context,
                  MaterialPageRoute(builder: (context) => OrigenDestino()));
              setState(() {
